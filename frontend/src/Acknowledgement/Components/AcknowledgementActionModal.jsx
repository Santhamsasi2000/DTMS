        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Set new status for this tapal</p>
            </div>
          </div>
          ...
          {/* ✅ Action Remarks removed */}

          {/* Buttons */}
          <div className="flex gap-3">
            <button
              onClick={onUpdate}
              className="flex-1 h-11 rounded-xl bg-[#003B7A] text-white text-sm
                font-semibold hover:bg-[#004A9A] active:scale-[0.98] transition-all"
            >
              Update Status
            </button>
            <button
